...
all_models1 <- 
	all_models %>%
	#map over each model and it's resamples, use the control parameters, and be noisy
 	workflow_map(., 
 	             resamples = model_folds, 
 	             control = control, 
 	             verbose = TRUE)

# save(all_models1,file="data/all_models1.RData")
```
...
```{r 02-illustrative-example-predicting-risk-of-ischemic-stroke-31, eval=FALSE,message=FALSE, warning=FALSE, cache=TRUE, include=FALSE, paged.print=FALSE}
