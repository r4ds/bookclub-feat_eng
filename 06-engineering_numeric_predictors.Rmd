...
# For plots
source("data/num_eg_data/06_Engineering_Numeric_Predictors/6_3_1_Linear_Projection_Methods/chicago_maps.R")

# ------------------------------------------------------------------------------

load("data/num_eg_data/Data_Sets/Chicago_trains/chicago.RData")
